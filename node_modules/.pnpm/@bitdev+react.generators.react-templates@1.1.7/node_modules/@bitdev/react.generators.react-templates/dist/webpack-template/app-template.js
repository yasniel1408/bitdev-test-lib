...
class ReactWebpackTemplate {
    constructor(name = 'react-cjs-app', description = 'A webpack-based React app with SSR for CJS support', hidden = false, env, installMissingDependencies = true, isApp = true) {
        this.name = name;
