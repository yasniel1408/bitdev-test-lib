...
class VitestTester {
    constructor(id, configPath, vitestWorker, logger, opts = {}) {
        this.id = id;
    ...
    static from(options) {
        ...
        return (context) => {
            ...
            return new VitestTester(id, options.config, worker, logger, options);
        };
    }
    version() {
    ...
    test(context) {
        return __awaiter(this, void 0, void 0, function* () {
            const viteConfig = yield (0, utils_1.getConfig)(this.configPath, context, false);
    ...
    watch(context) {
        return __awaiter(this, void 0, void 0, function* () {
            const viteConfig = yield (0, utils_1.getConfig)(this.configPath, context, true);
            const filters = (0, utils_1.patternsToArray)(this.opts, context);
            viteConfig.test.include = filters;
